...
![[editorial_nmapsCV.png]]

Al entrar a la web, vemos una página de una editorial de libros, tiene un apartado para subir un libro y una vista previa, por lo que nos aprovechamos de esto para aplicar un SSRF (Server Side Request Forgery) y ver si los puertos de la máquina muestran algo. Para ello, usamos Burpsuite

![[editorial_burpsuite.png]]
