...
Como podemos observar, se ejecutará código en la parte que dice `("os").system ("touch pwned")`. Lo cambiamos por un ``ping -c 1 10.10.17.184`` para ver si realiza una traza icmp y nos lo muestra por ``tcpdump``.
...
![[chemistry_sqlite.png]]

Encontramos usuarios con sus respectivas contraseñas hasheadas, las cuales podemos desencriptar con `hashcat` o usando herramientas en línea. Usaremos la de rosa porque es un usuario del sistema.

![[chemistry_passwd.png]]

`rosa|63ed86ee9f624c7b14f1d4f43dc251a5`

![[chemistry_hash.png|800]]
...
![[chemistry_headers.png]] Y podemos observar que el servicio y la versión es ``aiohttp/3.9.1``
